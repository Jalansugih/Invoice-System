-- BILLINGFLOW V30 — RESTORE PAYMENT JOURNAL ACCOUNTING FUNCTIONS
-- This migration restores the V14 accounting functions/triggers that are required
-- by record_payment_atomic() and payment inserts. It is safe to re-run.
-- Run after the base accounting tables (V12/V13) exist.
