          ...
          <div>
            <div className="border border-dashed border-emerald-400 bg-emerald-50/30 p-3 rounded-xl text-emerald-800 space-y-1">
              ...
              <p className="text-[11px] text-emerald-700 leading-relaxed">
                Kuitansi ini merupakan bukti pembayaran resmi yang sah dan mengikat yang dikeluarkan oleh sistem JKN.
              </p>
            </div>
          </div>
          ...
          <div className="text-center sm:text-right flex flex-col justify-between items-center sm:items-end">
            ...
            <div>
              <p className="font-bold text-slate-900 underline uppercase tracking-tight">
                {org.signatureName || payment.recordedBy || 'Finance & Cashier Officer'}
              </p>
              <p className="text-[11px] text-slate-600 font-medium mt-0.5">
                {org.signatureRole || 'Finance & Treasury Department'}
              </p>
            </div>
          </div>
        </div>
